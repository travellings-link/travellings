...
- 网页已有较多内容（应有20篇文章或10篇原创文章，需要已持续更新一段时间）；
- 强制启用 https 。
...
> 💡 选购域名时，您应注意它的**续费价格**。某些域名，如 `bar, best, cloud, digital, guru, life, live, miami, online, rest, shop, site, store, surf, today, website, world, sapce, fun` ，第二年续费就会暴涨到15美刀以上（`.com` 域名也就每年8美刀）。更换域名总会有损失 [#556](https://github.com/travellings-link/travellings/issues/566) ，不妨一开始就做好准备。开往成员可以通过[开往成员权益申请](http://linlinzzo-top.mikecrm.com/NzM3Huo)来申请免费的二级域名（例如moechun.travellings.cn）。
