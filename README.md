...
目前，开往正在与十年之约合作，在通过项目组的复审和认证后，非博客站长的开往成员也可以参加十年之约论坛所举办的活动（注：博客站长需要加入十年之约，以十年之约成员的身份参加）。

在经过和我们赞助商的讨论下，我们为开往成员争取到了一个福利，加入开往官方群
1.找蓝易云获取宣传模板，然后在博客网站中发一篇关于赞助商的文章，即可获得一个红包
2.你可以获取一个aff链接，当用户新购，续费，二次购买都可以获得提成
3.凡参与活动者将拥有抽奖资格，获得隐藏福利
4.开往成员拥有专属折扣
